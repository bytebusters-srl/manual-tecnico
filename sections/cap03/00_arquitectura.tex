...
\hline
\rowcolor{grisTecnico}
PostgreSQL (Supabase) & JDBC / \textit{pooler} & Dura & Reintentos del \textit{pooler}; sin BD el sistema no opera (por diseño). \\
\hline
...
\begin{tikzpicture}[node distance=1.1cm and 1.8cm]
    ...
    % Almacén de datos
    \node[c4datos, right=2.6cm of api] (db) {PostgreSQL\\\scriptsize esquema \texttt{core}\\\scriptsize(Supabase)};
...
\subsection{Componentes internos de \texttt{ethoshubB}}
...
\subsection{Componentes internos de \texttt{ethoshubF}}
