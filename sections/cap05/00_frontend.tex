% =============================================================================
% CAPÍTULO 5 — DISEÑO DETALLADO DEL FRONTEND (EthosFront)
...
\texttt{EthosFront}, el cliente que consume la API REST descrita en el
...
\input{sections/cap05/01_componentes}   % 5.1 Árbol y jerarquía de componentes
\input{sections/cap05/02_userflows}     % 5.2 User flows
\input{sections/cap05/03_sitemap}       % 5.3 Sitemap y enrutamiento + PWA
\input{sections/cap05/04_ui}            % 5.4 Estrategia de interfaz y wireframes
\input{sections/cap05/05_zustand}       % 5.5 Gestión de estado (Zustand)
\input{sections/cap05/06_servicios}     % 5.6 Consumo asíncrono de servicios
\input{sections/cap05/07_i18n_build}    % 5.7 i18n, OAuth y optimización
\input{sections/cap05/08_calidad}       % 5.8 Calidad del código y tooling
