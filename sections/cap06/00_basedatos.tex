...
\label{ch:basedatos}
\resumenCapitulo{Este capítulo expone en su totalidad el motor de datos PostgreSQL sobre
Supabase: los esquemas lógicos y el diagrama entidad-relación, el diccionario de datos
...
alojada en \textbf{Supabase} sobre \textbf{PostgreSQL 17.6}. Constituye el documento de
...
\input{sections/cap06/01_diccionario}
\input{sections/cap06/02_integridad}
\input{sections/cap06/03_indexacion}
\input{sections/cap06/04_programable}
\input{sections/cap06/05_concurrencia}
\input{sections/cap06/06_seguridad_rls}
