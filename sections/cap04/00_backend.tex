% =============================================================================
% CAPÍTULO 4 — DISEÑO DETALLADO DEL BACKEND (ethoshubB)
...
servidor \texttt{ethoshubB}. Mientras el capítulo~\ref{ch:arquitectura} (pág.~\pageref{ch:arquitectura})
...
\textbf{jOOQ} sobre PostgreSQL~17.6 (Supabase) y se empaqueta como un único \textit{JAR}
...
\input{sections/cap04/01_api_rest}        % 4.1 Arquitectura de la API REST e interfaces
\input{sections/cap04/02_clases}          % 4.2 Diagramas de clases por dominios
\input{sections/cap04/03_secuencias}      % 4.3 Diagramas de secuencia
\input{sections/cap04/04_realtime}        % 4.4 Comunicación en tiempo real
\input{sections/cap04/05_seguridad}       % 4.5 Seguridad y manejo de excepciones
\input{sections/cap04/06_configuracion}   % 4.6 Configuración, empaquetado y despliegue
