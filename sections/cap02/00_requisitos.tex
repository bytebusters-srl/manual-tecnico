...
\begin{tikzpicture}[node distance=0.7cm and 2.2cm,
    ...
    \node[mec, right=of conc] (m2) {Pool de conexiones + idempotencia (V7)};
...
\begin{TablaRF}
RNF-CONC-01 & El acceso a PostgreSQL~15.10 se realiza mediante un \textit{pool} de conexiones, acotando el número de conexiones simultáneas del backend. & Alta \\ \hline
