\begin{titlepage}
    ...
    \begin{center}
        ...
        \vspace{0.35cm}
        {\Huge\bfseries\color{colorPrimario} Manual Técnico\par}
        \vspace{0.15cm}
        {\LARGE\bfseries de Arquitectura y Diseño\par}
        \vspace{0.35cm}
        {\large Plataforma \textbf{EthosHub}\par}
        {\normalsize\itshape Sistema de gestión de talento y reclutamiento basado en valores\par}
        \vspace{0.3cm}
        \rule{\textwidth}{1.2pt}\par
    \end{center}
    ...
    \begin{center}
        ...
        \begin{tabularx}{0.92\textwidth}{|>{\bfseries\color{colorPrimario}}l|X|}
            ...
            \hline
            \rowcolor{grisTecnico}
            Tipo de artefacto & Descripción de diseño de software (SDD) \\
            \hline
            \rowcolor{headerTabla}
            ...
            \hline
            Correo de contacto & contacto@bytebusters.com \\
            \hline
            \rowcolor{grisTecnico}
